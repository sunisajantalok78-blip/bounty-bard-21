...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Autonomous AI dashboard that scans, pitches, and converts paid dev bounties 24/7." },
      { property: "og:title", content: "Bounty Hunter — Autonomous AI Lead Engine" },
      { property: "og:description", content: "Autonomous AI dashboard that scans, pitches, and converts paid dev bounties 24/7." },
